...
# 1. Memuat model dengan pengaman try-except
model = None
try:
...
# 2. Membuat Form Input di Sidebar (Ini harus dibuat DULUAN)
...
# 3. Menggabungkan input user dengan kolom yang kurang (Diletakkan SETELAH form dibuat)
user_input = {
...
# Amankan variasi penulisan nama kolom (pake spasi vs pake underscore)
